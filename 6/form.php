...
if (isset($file1)) {
    echo "<br>";
    echo "¡ Characteristics file2 !";
    echo "<br>";
    print_r("Name: " . $file2['name']);
    echo "<br>";
    print_r("Type: " . $file2['type']);
    echo "<br>";
    print_r("Size: " . $file2['size']);
    echo "<br>";
    print_r("Tmp_name: " . $file2['tmp_name']);
    echo "<br>";
    print_r("Error: " . $file2['error']);
    echo "<br>";
}
?>
